   ...
   public abstract class AuditTestsBase
   {
         ...
         where T : class, IAudit, new()
      {
         ...
         using (var unitOfWork = this.unitOfWorkFactory.Create())
         {
            ...
            {
               AssertDateTimeEqual(createdAtDateTime(audit), new DateTime(2010, 3, 23, 1, 2, 3, 111));
            }
            ...
            {
               AssertDateTimeEqual(modifiedAtDateTime(audit), new DateTime(2010, 3, 23, 1, 2, 3, 111));
            }
         }
      }
         ...
         where T : class, IAudit, new()
      {
         ...
         using (var unitOfWork = this.unitOfWorkFactory.Create())
         {
            ...
            if (modifiedAtDateTime != null)
            {
               AssertDateTimeEqual(modifiedAtDateTime(audit), new DateTime(2011, 4, 19, 4, 5, 6, 222));
            }
         }
      }
